...
if( ! function_exists( 'ingenuity_styles' ) ) {
  ...
  function ingenuity_styles(){
  		wp_enqueue_style( 'child-theme-style', get_template_directory_uri() . '/style.css', array() ); // Stylesheet for custom css
		...
		wp_enqueue_style( 'fontawesome', get_stylesheet_directory_uri() . '/css/font-awesome.min.css', array() ); // FontAwesome Stylesheet  
  		...
  		wp_enqueue_script( 'ingenuityjs', get_stylesheet_directory_uri() . '/js/ingenuityjs.js', 'jquery', 3.0, true ); //Child theme js
}
