...
if( ! function_exists('inortho_cto')) {	
  ...
  function inortho_cto($atts) {
		$attributes = shortcode_atts(array(
                        ...
                        'txtcolor' =>'#fff'
					), $atts, 'ctotitle','bgcolor','src','btncolor','btntitle','btnlink','ctocontent','txtcolor'
                 	);
					...
					<div class="cto-container">
						...
						<div class="inortho-cto-body">																															
							<div class="cto-content">
								...
								<p><a class="cto-btn" style="color:'.$attributes["txtcolor"].';background-color:'.$attributes["btncolor"].'" href="'.$attributes["btnlink"].'">'.$attributes["btntitle"].'</a></p></div>
							</div>
						</div>
				</div>';
